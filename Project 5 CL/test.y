...
%%
S    : headers datatype  MAIN_TOK LPAREN_TOK RPAREN_TOK BLOCK      {printf("Syntax for Main Function is Ok....\n");}
     ;
...
stmt:     DECLARATION SEMICOLON_TOK
        ...
        | FUNCTION SEMICOLON_TOK {printf("Function Call detected at %d\n",yylineno)}    
          ;
...
value: ID_TOK | constant | LPAREN_TOK datatype RPAREN_TOK ID_TOK;
...
FUNCTION: ID_TOK LPAREN_TOK args RPAREN_TOK
%%
